...
public class ShortcodeManager implements PreparableReloadListener {
    ...
    public static RichNode hydrateWith(String code, JsonElement[] args, @Nullable RichNode slot) {
    ...
    /**
     * テキスト構文用（":shortcode.arg1,arg2:" など）。
     * argSpec に従って String[] を適切な型の JsonElement[] に事前変換してから hydrate する。
     */
    public static RichNode resolve(String code, String[] textArgs) {
        return hydrateWith(code, parseTextArgs(code, textArgs), null);
    }
